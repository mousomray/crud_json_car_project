...
import { addCustomer } from '../Service/Api' // Import addCustomer function 
...
const Book = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(ErrorList).length === 0) {
            await addCustomer(customer) // call addCustomer function

            toast.success("Customer Booking Successfully")

            setTimeout(() => {
                //Navigate to showuser page
            ...
            //Loading will be stop after submitting the data
            setLoading(false)
